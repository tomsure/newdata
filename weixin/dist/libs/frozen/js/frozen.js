...
! function(a) {
	...
	function f() {
		if("default" === w.swipeAnim) {
			...
			a(u).css({
				"z-index": 0
			}), "horizontal" === w.direction && l >= k ? c.css({
				"z-index": 2,
				display: "block",
	...
	function g(b, c) {
		if(p = b, "default" === w.swipeAnim) {
			var d = 0;
			d = "horizontal" === w.direction ? b * -r : b * -s, t.css("horizontal" === w.direction ? {
				"-webkit-transform": "matrix(1, 0, 0, 1, " + d + ", 0)"
			} : {
				"-webkit-transform": "matrix(1, 0, 0, 1, 0, " + d + ")"
			})
		} else "cover" === w.swipeAnim && ("keep-backward" === c && w.drag ? (u.removeClass("drag"), a(u[p - 1]).css("horizontal" === w.direction ? {
			"-webkit-transform": "translateX(-100%)"
		} : {
			"-webkit-transform": "translateY(-100%)"
		})) : "keep-forward" === c && w.drag ? (u.removeClass("drag"), a(u[p + 1]).css("horizontal" === w.direction ? {
			"-webkit-transform": "translateX(100%)"
		} : {
			"-webkit-transform": "translateY(100%)"
		})) : "forward" === c && w.drag ? (u.removeClass("drag"), a(u[p - 1]).addClass("back"), u[p].style.webkitTransform = "translate(0, 0)") : "backward" === c && w.drag ? (u.removeClass("drag"), a(u[p + 1]).addClass("back"), u[p].style.webkitTransform = "translate(0, 0)") : "forward" !== c || w.drag ? "backward" !== c || w.drag || (t.addClass("animate"), a(u[p + 1]).addClass("back"), a(u[p]).addClass("front").show()) : (t.addClass("animate"), a(u[p - 1]).addClass("back"), a(u[p]).addClass("front").show()));
	...
	var k, l, m, n, o, p, q, r, s, t, u, v, w, x = !1,
		y = !0;
	...
	h.prototype = {
		...
		show: function(a) {
			...
			if(!this._isShown && (this.currentTrigger || a)) {
				...
				var f = c(),
					g = 2;
				e.isFloat && (this._floatTrigger(), this.currentTrigger.css({
					zIndex: e.zIndex + 1
				}));
				var h = this._getMaskPos(e.startPos, e.expandAxis),
					i = "x" == e.expandAxis ? "scale(0,1)" : "y" == e.expandAxis ? "scale(1,0)" : "scale(0,0)";
				this._mask.css({
					left: h[0] + e.offset[0],
					top: h[1] + e.offset[1],
		...
		hide: function() {
			var a = this;
			a.option.callback("hide", a), this._isShown && (this._isDismiss = !0, this._mask.css({
				"-webkit-transform": this._originTransform
			}))
		},
		hidden: function() {
			this._isShown = !1, this._isDismiss = !1, this._mask.css({
				"-webkit-transition": "none"
			}), this._relaseDefault(), this.currentTrigger.css(this._triggerOriginCss)
		},
		...
		_floatTrigger: function() {
			...
			}, d(this.currentTrigger) || this.currentTrigger.css({
				position: "relative"
			})
		},
		_getMaskPos: function(a, b) {
			this.position || (this.position = {}, this.position.screenWidth = document.documentElement.clientWidth, this.position.screenHeight = document.documentElement.clientHeight), "x" == b ? this._mask.css({
				height: this.position.screenHeight
			}) : "y" == b && this._mask.css({
				width: this.position.screenWidth
			}), this.position.scrollTop = document.body.scrollTop, this.position.scrollLeft = document.body.scrollLeft, this.position.offsetTop = this.element.offset().top, this.position.offsetLeft = this.element.offset().left, this.position.triggerLeft = this.currentTrigger.offset().left, this.position.triggerTop = this.currentTrigger.offset().top, this.position.triggerHeight = this.currentTrigger.height(), this.position.triggerWidth = this.currentTrigger.width();
			var c = parseInt(this._mask.css("width")),
				d = parseInt(this._mask.css("height")),
				e = this.position.scrollLeft - this.position.offsetLeft + this.position.screenWidth / 2 - c / 2,
				f = 0;
		...
		_aniMask: function(a, b, c) {
			...
			var e = Math.ceil(this.position.screenWidth / parseInt(this._mask.css("width"))) * c,
				f = Math.ceil(this.position.screenHeight / parseInt(this._mask.css("height"))) * c;
			setTimeout(function() {
				d._mask.css({

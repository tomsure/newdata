	 ...
	 $('#artificial').click(function(){
	 	layui.use('layer',function(){
	 		...
	 		layer.open({
	 			type:1,
	 			area:['480px','600px'],
	 			title:['新增故障信息',"font-size:18px;font-weight:800;"],
	 			content:$("#addArtificial")
	 		})
	 	})
	 })
	 //新增
	 $('#addDealerCreate').click(function(){
		 layui.use('layer',function(){
			 var layer=layui.layer;
			 layer.open({
				 type:1,
...
//商品列表结束
 ...
 //卡片管理
     ...
     //设备型号设置
     $('#addEquipmentSetting').click(function(){
    	 layui.use('layer',function(){
    		 var layer=layui.layer;
    		 layer.open({
    			 title:['新增套餐','font-size:20px;font-weight:800'],
    			 type:1,
    			 area:['400px','600px'],
    			 content:$('#addEquipmentSettingBox')
      ...
      $('#addPayment').click(function(){
      	  layui.use('layer',function(){
      	  	 var layer=layui.layer;
      	  	      layer.open({
      	  	      	    type:1,
      	  	      	    title:['新增大客户充值缴费','font-size:18px;font-weight:700;'],
      	  	      	    area:['500px','550px'],
      	  	      	    content:$('#addDlealer')
      	  	      })
      	  })
               ...
               //补卡申请
      $('#addReissueApply').click(function(){
      	  layui.use('layer',function(){
      	  	 var layer=layui.layer;
      	  	      layer.open({
      	  	      	    type:1,
      	  	      	    title:['新增补卡申请','font-size:18px;font-weight:700;'],
      	  	      	    area:['500px','550px'],
      	  	      	    content:$('#addReissueApplyBox')
      	  	      })
      	  })
      })
      ...
      $('#addPayments').click(function(){
      	  layui.use('layer',function(){
      	  	 var layer=layui.layer;
      	  	      layer.open({
      	  	      	    type:1,
      	  	      	    title:['新增流量比例转换','font-size:18px;font-weight:700;'],
      	  	      	    area:['500px','550px'],
      	  	      	    content:$('#addDlealers')
      	  	      })
      	  })
               ...
               //流量比例转换  iccid的新增弹窗
      $('#addPaymentb').click(function(){
      	  layui.use('layer',function(){
      	  	 var layer=layui.layer;
      	  	      layer.open({
      	  	      	    type:1,
      	  	      	    title:['新增iccid','font-size:18px;font-weight:700;'],
      	  	      	    area:['500px','550px'],
      	  	      	    content:$('#addDlealerb')
      	  	      })
      	  })

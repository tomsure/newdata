...
<body class="page-body">
    ...
    <div class="search-box check-btn">
        <div class="check-btn">
        	...
        	<button class="btn btn-default" >停机</button>
            <button class="btn btn-default" >复机</button>
            <button class="btn btn-default">套餐变更</button>

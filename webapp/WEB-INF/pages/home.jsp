            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                    	...
                    	<ul class="nav nav-second-level">
							<li><a class="J_menuItem" data-href="packageList">套餐设置</a></li>
					        <li><a class="J_menuItem" data-href="packagePutaway">套餐上架</a></li>
                    	</ul>
                    </li>
                    <!--套餐管理结束-->
                    <!--库存管理开始-->
                    <li>
                    	...
                    	<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" data-href="equipmentSetting">设备型号设置</a></li>
                    	</ul>
                    </li>
                     <!--库存管理结束-->
                    <!--返佣管理开始-->
                    <li>
                    	...
                    	<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" data-href="rebateRulesSet">返佣规则更改</a></li>
...
<!-- 							<li><a class="J_menuItem" data-href="distributionUserWDet">用户提现明细</a></li>
						    ...
						    <li><a class="J_menuItem" data-href="distributionSet">大区域经销商规则</a></li>
						    <li><a class="J_menuItem" data-href="dealerCreate">大区域经销商创建</a></li>
						    <li><a class="J_menuItem" data-href="dealerApply">大区域分润申请</a></li>
...
<!-- 						    <li><a class="J_menuItem" data-href="distributionDet">分销明细</a></li>
                    ...
                    <!--用户中心开始-->
                    <li>
                    	<a href=""><i class="fa fa-table"></i> <span class="nav-label">用户中心</span><span class="fa arrow"></span> </a>
                    	<ul class="nav nav-second-level">
 							<li><a class="J_menuItem" data-href="userManage">用户管理</a></li>
                    	</ul>
                    </li>
                    <!--用户中心结束-->
                    ...
                    <!--卡片管理开始-->
                       <li>
                    	...
                    	<ul class="nav nav-second-level">                    	
							...
							<li><a class="J_menuItem" data-href="reissueApply">补卡申请</a></li>
							<li><a class="J_menuItem" data-href="prepareCancellation">预销号卡片</a></li>
							<li><a class="J_menuItem" data-href="cancellationRule">预销号规则</a></li>
							<li><a class="J_menuItem" data-href="flowRefund">流量退费申请</a></li>
